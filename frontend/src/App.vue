  ...
  <div class="app-shell">
    <header class="navbar">
      ...
      <nav :class="{open:menuOpen}" aria-label="Main navigation" @click="menuOpen=false">
        ...
        <template v-if="auth.role==='admin'"><RouterLink to="/admin">Dashboard</RouterLink><RouterLink to="/admin/users">Users</RouterLink><RouterLink to="/admin/vendors">Vendors</RouterLink><RouterLink to="/admin/vendor-applications">Applications</RouterLink><RouterLink to="/admin/rewards">Rewards</RouterLink><RouterLink to="/admin/orders">Orders</RouterLink></template>
      </nav>
