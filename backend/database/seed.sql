...
('10000000-0000-4000-8000-000000000004', 'Drinks Vendor', 'drinks.vendor@test.com', '$2y$10$Sh04P.3/W1KAyTU/bV6Y2.dbdhlE72DmSsKKXijMvmIj63n.AHS9q', 'vendor'),
('10000000-0000-4000-8000-000000000005', 'Snack Vendor', 'snacks.vendor@test.com', '$2y$10$Sh04P.3/W1KAyTU/bV6Y2.dbdhlE72DmSsKKXijMvmIj63n.AHS9q', 'vendor')
...
('20000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000004',
 'Library Drinks Bar', 'Cold drinks, coffee, tea and quick study break refreshments.', 'Library Lobby', '8:00 AM - 8:00 PM', 1),
('20000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000005',
 'Grab & Go Snacks', 'Affordable wraps, pastries and light bites between classes.', 'Block C Kiosk', 'Mon-Fri 9:00 AM - 6:00 PM', 1)
ON DUPLICATE KEY UPDATE
...
('30000000-0000-4000-8000-000000000007', '20000000-0000-4000-8000-000000000002', 'Caramel Iced Coffee', 'Smooth iced coffee with caramel syrup and milk.', 6.00, 'Drinks', 1, 1, 1),
('30000000-0000-4000-8000-000000000008', '20000000-0000-4000-8000-000000000002', 'Honey Lemon Tea', 'Fresh lemon tea with honey, served cold.', 4.50, 'Drinks', 1, 1, 1),
('30000000-0000-4000-8000-000000000009', '20000000-0000-4000-8000-000000000002', 'Mineral Water', 'Chilled bottled water for quick pickup.', 1.50, 'Drinks', 1, 1, 1),
('30000000-0000-4000-8000-000000000010', '20000000-0000-4000-8000-000000000003', 'Tuna Mayo Sandwich', 'Soft bread filled with tuna mayo and crisp lettuce.', 5.50, 'Snacks', 1, 0, 1),
('30000000-0000-4000-8000-000000000011', '20000000-0000-4000-8000-000000000003', 'Vegetable Curry Puff', 'Flaky pastry with spiced potato and vegetables.', 2.00, 'Snacks', 1, 1, 1),
('30000000-0000-4000-8000-000000000012', '20000000-0000-4000-8000-000000000003', 'Chicken Sausage Roll', 'Warm pastry roll with chicken sausage filling.', 4.00, 'Snacks', 1, 0, 1)
ON DUPLICATE KEY UPDATE
...
INSERT INTO orders (id, customer_id, vendor_id, pickup_at, total, payment_status, payment_reference, payment_method, status, created_at) VALUES
('40000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', TIMESTAMP(CURDATE(), '12:30:00'), 10.50, 'mock_paid', 'seed_mock_001', 'mock', 'placed', TIMESTAMP(CURDATE(), '10:05:00')),
('40000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', TIMESTAMP(CURDATE(), '12:45:00'), 8.00, 'mock_paid', 'seed_mock_002', 'mock', 'preparing', TIMESTAMP(CURDATE(), '10:20:00')),
('40000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', TIMESTAMP(CURDATE(), '13:00:00'), 9.00, 'mock_paid', 'seed_mock_003', 'mock', 'ready', TIMESTAMP(CURDATE(), '11:10:00')),
('40000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', TIMESTAMP(CURDATE(), '11:45:00'), 15.00, 'mock_paid', 'seed_mock_004', 'mock', 'collected', TIMESTAMP(CURDATE(), '09:40:00'))
ON DUPLICATE KEY UPDATE
    pickup_at = VALUES(pickup_at), total = VALUES(total),
    payment_status = VALUES(payment_status), payment_reference = VALUES(payment_reference),
