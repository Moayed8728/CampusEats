...
('10000000-0000-4000-8000-000000000001', 'Student Demo', 'student@test.com', '$2y$10$xEpg8NOj/zZE04ZRu7/GC.QYgrhvSu9VBhcmqLguVuX.vgmQu0ney', 'student'),
('10000000-0000-4000-8000-000000000002', 'Vendor Demo', 'vendor@test.com', '$2y$10$xEpg8NOj/zZE04ZRu7/GC.QYgrhvSu9VBhcmqLguVuX.vgmQu0ney', 'vendor'),
('10000000-0000-4000-8000-000000000003', 'Admin Demo', 'admin@test.com', '$2y$10$xEpg8NOj/zZE04ZRu7/GC.QYgrhvSu9VBhcmqLguVuX.vgmQu0ney', 'admin')
...
('20000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000002',
 'Campus Nasi Corner', 'Malaysian comfort food, wok-fired fresh for campus pickup.', 1)
ON DUPLICATE KEY UPDATE
    owner_id = VALUES(owner_id), name = VALUES(name), description = VALUES(description), is_active = 1;
